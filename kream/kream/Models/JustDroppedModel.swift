...
extension JustDroppedModel {
    static func dummy() -> [JustDroppedModel] {
        return [
            JustDroppedModel(image: .imageMatinkim, imageColor: UIColor(red: 234/255, green: 240/255, blue: 245/255, alpha: 1), trade: "거래 20.4만", saved: .iconSavedNone, brand: "Matin Kim", goods: "Matin Kim Logo Coating Jumper", price: "228,000원"),
